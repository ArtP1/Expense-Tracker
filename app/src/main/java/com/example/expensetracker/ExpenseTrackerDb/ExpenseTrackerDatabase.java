...
@Database(entities = {Transaction.class, User.class, Category.class, PaymentMethod.class, Currency.class, Notification.class, DigitalWallet.class, UserDigitalWallet.class}, version = 1, exportSchema = false)
    ...
    public static void initializeDatabase(final Context context) {
        ...
        executor.execute(() -> {
            try {
                ...
                db.runInTransaction(() -> db.transactionDAO().insertAllUserTransactions(PrepopulateDb.insertAllUserTransactions()));
